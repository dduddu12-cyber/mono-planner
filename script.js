...
async function _renderMemoPanelView() {
  ...
  mpv.innerHTML = `
    ...
    <div class="nb-canvas-toolbar" id="mpv-cv-toolbar" style="flex-shrink:0">
      ...
      <button class="nb-tool-btn" id="mpv-collapse-all" title="모든 박스를 접어 제목만 표시">▸ 모두 접기</button>
      <button class="nb-tool-btn" id="mpv-expand-all" title="모든 박스 펼치기">▾ 모두 펼치기</button>
      <span class="toolbar-divider"></span>
  ...
  // 모두 접기 / 모두 펼치기
  document.getElementById('mpv-collapse-all').addEventListener('click', () => nbSetAllCollapsed(true));
  document.getElementById('mpv-expand-all').addEventListener('click', () => nbSetAllCollapsed(false));
