...
async function _renderMemoPanelView() {
  ...
  mpv.innerHTML = `
    ...
    <div id="mpv-text" contenteditable="true" spellcheck="false" style="flex:1;min-height:120px;border:none;border-top:1px solid var(--border);padding:0.85rem 1rem;font-size:0.9rem;line-height:1.7;background:var(--bg);font-family:inherit;color:var(--text);outline:none;overflow-y:auto;word-break:break-word"></div>
    ${memo.hasDrawing ? `
